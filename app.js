...
function IcUtilisateur(choix) {
        ...
        if (choix == "pierre") {
                document.getElementById('joueur').setAttribute("src", "img/crystal.png");
                signeU = "pierre";
        }
        else if (choix == "feuille") {
                document.getElementById('joueur').setAttribute("src", "img/scroll.png");
                signeU = "feuille";
        } else {
...
function ChoixOrdi() {
        ...
        if (random == 1) {
                document.getElementById('ordinateur').setAttribute("src", "img/crystal.png");
                signeO = "pierre";
        }
        else if (random == 2) {
                document.getElementById('ordinateur').setAttribute("src", "img/scroll.png");
                signeO = "feuille";
        } else {
...
function comparaison() {
        ...
        tourJ == tourJ++;
                switch (tour) {
                        case 1:
                                ...
                                document.getElementById('cercle-J-1').style.backgroundColor = 'yellowgreen';
                                ...
                                break;
                        case 2:
                                document.getElementById('cercle-J-2').style.backgroundColor = 'yellowgreen';
                                ...
                                break;
                        case 3:
                                document.getElementById('cercle-J-3').style.backgroundColor = 'yellowgreen';
                ...
                tourPC == tourPC++;
                if (tour == 1) {
                        document.getElementById('cercle-PC-1').style.backgroundColor = 'yellowgreen';
                        document.getElementById('cercle-PC-1').style.border = 'none';
                        ...
                        document.getElementById('cercle-PC-2').style.backgroundColor = 'yellowgreen';
                        document.getElementById('cercle-PC-2').style.border = 'none';
                        ...
                        document.getElementById('cercle-PC-3').style.backgroundColor = 'yellowgreen';
                        document.getElementById('cercle-PC-3').style.border = 'none';
        ...
        switch (tour) {
                case 1:
                         document.getElementById('cercle-1').style.backgroundColor = 'pink';
                         document.getElementById('cercle-1').style.border = 'none';
                         

                        break;
                case 2:
                         document.getElementById('cercle-2').style.backgroundColor = 'pink';
                         document.getElementById('cercle-2').style.border = 'none';


                        break;
                case 3:
                         document.getElementById('cercle-3').style.backgroundColor = 'pink';
